    ...
    <div class="flexbox">
        <div class="filter" id="desktop">
                    ...
                    if($result){
                        if(mysqli_num_rows($result) > 0){
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                echo "<div>";
                                echo "<a href='products.php?gender=$gender&category=$category&type=$type&brand=$bname&price=$price&sale=$sale&name=$name'>";
                                echo "$bname";
                                echo "</a></div>";
                            }
                        }else {
                        ...
                        echo "<div>";
                        echo "<a href='products.php?gender=$gender&category=$category&type=$type&brand=none&price=$price&sale=$sale&name=$name'>";
                        echo "No Filter";
                        echo "</a></div>";
                    }
                ?>
            ...
            <div class="filter-child collapse" id="collapseFilter2">
                <?php
                    echo "<div>";
                    echo "<a href='products.php?gender=$gender&category=$category&type=$type&brand=$brand&price=$price&sale=ASC&name=$name'>";
                    echo "Ascending";
                    echo "</a></div>";

                    echo "<div>";
                    echo "<a href='products.php?gender=$gender&category=$category&type=$type&brand=$brand&price=$price&sale=DESC&name=$name'>";
                    echo "Descending";
                    echo "</a></div>";

                    echo "<div>";
                    echo "<a href='products.php?gender=$gender&category=$category&type=$type&brand=$brand&price=$price&sale=none&name=$name'>";
                    echo "No Filter";
                    echo "</a></div>";
                ?>
            </div>
            ...
            <div class="filter-child collapse" id="collapseFilter3">
                <?php
                    echo "<div>";
                    echo "<a href='products.php?gender=$gender&category=$category&type=$type&brand=$brand&price=ASC&sale=$sale&name=$name'>";
                    echo "Ascending";
                    echo "</a></div>";

                    echo "<div>";
                    echo "<a href='products.php?gender=$gender&category=$category&type=$type&brand=$brand&price=DESC&sale=$sale&name=$name'>";
                    echo "Descending";
                    echo "</a></div>";

                    echo "<div>";
                    echo "<a href='products.php?gender=$gender&category=$category&type=$type&brand=$brand&price=none&sale=$sale&name=$name'>";
                    echo "No Filter";
                    echo "</a></div>";
                ?>
            </div>
            ...
            <div class="filter-child collapse" id="collapseFilter4">
                ...
                <?php
                    ...
                    echo "<div>";
                    echo "<a href='products.php?gender=$gender&category=$category&type=$type&brand=$brand&price=$price&sale=$sale&name=none'>";
                    echo "No Filter";
                    echo "</a></div>";
                ?>
            </div>
